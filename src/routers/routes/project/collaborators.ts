...
export async function getCollaborators(req: expressType.Request, res: expressType.Response): Promise<void> {
    try {
        const user = req.user;
...
export async function inviteCollaborator(req: expressType.Request, res: expressType.Response): Promise<void> {
    try {
        const user = req.user;
        const projectId = req.params.id;
...
export async function removeCollaborator(req: expressType.Request, res: expressType.Response): Promise<void> {
    try {
        const user = req.user;
        const projectId = req.params.id;
...
export async function updateCollaborator(req: expressType.Request, res: expressType.Response): Promise<void> {
    try {
        const user = req.user;
        const projectId = req.params.id;
...
export async function checkCollaboratorToken(req: expressType.Request, res: expressType.Response): Promise<void> {
    try {
        const projectId = req.params.id;
...
export async function acceptInvite(req: expressType.Request, res: expressType.Response): Promise<void> {
    try {
        const user = req.user;
