...
const { isAdmin, isAdminOrToken } = require('./guards/user');
...
router.get('/organizations', isAdmin, adminRoutes.getOrganizations);
router.post('/organization', isAdmin, adminRoutes.createOrganization);
router.delete('/organization/:organizationId', isAdmin, adminRoutes.deleteOrganization);
