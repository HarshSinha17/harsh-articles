...
const { Collaborators, Settings } = require('./routes/project');
...
router.post('/:id/update-custom-domain', isLoggedIn, Settings.updateCustomDomain);
router.post('/:id/verify-custom-domain', isLoggedIn, Settings.verifyCustomDomain);
