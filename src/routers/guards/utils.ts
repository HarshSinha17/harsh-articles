...
import type { IModelGovernance } from '../../models/organization/organization-models-access-control';
...
export function createGuard<ModelType extends Document, PermissionType extends string, RoleType extends string>(
    governance: IModelGovernance<PermissionType, RoleType>,
    model: RestrictedModel<ModelType, RoleType>,
...
export function createNestedGuard<
    HostModelType extends Document,
    PermissionType extends string,
    RoleType extends string,
    NestedField extends string
>(
    governance: IModelGovernance<PermissionType, RoleType>,
    hostModel: ModelWithRestrictedNestedEntities<HostModelType, NestedField, RoleType>,
