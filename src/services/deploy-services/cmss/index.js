 ...
 * @typedef {({ project: ProjectModel, user: Object })} stagedChanges
...
/**
 * @typedef {createPage | duplicatePage | updatePage | hasChanges | getStagedChanges | publishDrafts | hasAccess | contextForBuild | onWebhook | envForContainer | preProvision | provision} CMSInterface
 */
...
/**
 * @param {'createPage' | 'duplicatePage' | 'updatePage' | 'hasChanges' | 'getStagedChanges' | 'hasAccess' | 'publishDrafts' | 'createObject' | 'envForContainer' | 'provision' | 'customImport' | 'customImportEnvVars' } op
