...
export interface IOrganizationMembershipInviteModel {
    addMembershipInvite(
        id: Types.ObjectId,
        user: IUserDoc,
        email: string,
        role?: OrganizationRole
    ): Promise<{ organization: IOrganizationDoc; token: string }>;
    removeMembershipInvite(id: Types.ObjectId, user: IUserDoc, inviteId: string): Promise<IOrganizationDoc>;
    acceptMembershipInvite(id: Types.ObjectId, user: IUserDoc, token: string): Promise<IOrganizationDoc>;
}
